    ...
    <section class="features section-padding-100">
        <div class="container">
            <div class="section-heading text-center">
                ...
                <div class="sect-icon justify-content-center fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="service-img-wrapper col-lg-6 col-md-12 col-sm-12">
                    <div class="image-box">
                        <img src="../../../assets/img/core-img/app-3.png" class="img-responsive center-block" alt="">
                    </div>
                </div>
            </div>
        </div>
